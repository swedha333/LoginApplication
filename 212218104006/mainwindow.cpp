    ...
    : QMainWindow(parent)
{
    ...
    l->move(100,50);
    QPixmap p("C:/Users/abix/OneDrive/Documents/SimpleLoginForm_212218104007/styles/static/login.png");
    l->setPixmap(p.scaled(20,20));

    QLabel *lb=new QLabel(this);
    lb->move(180,25);
    lb->setAlignment(Qt::AlignHCenter);
    QPixmap pi("C:/Users/abix/OneDrive/Documents/SimpleLoginForm_212218104007/styles/static/username.png");
    ...
    QPixmap pix("C:/Users/abix/OneDrive/Documents/SimpleLoginForm_212218104007/styles/static//password.png");
    ...
    connect(btn,&QPushButton::clicked,[=](){
        ...
        QString p=lie->text();
        if(uname=="Abishekk"&& p=="212218104007")
        {
