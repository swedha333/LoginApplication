    ...
    : QMainWindow(parent)
{
    ...
    l->move(100,50);
    QPixmap p("C:/Documents/SimpleLoginForm_212218104029/styles/login.png");
    l->setPixmap(p.scaled(20,20));

    QLabel *lb=new QLabel(this);
    lb->move(180,25);
    lb->setAlignment(Qt::AlignHCenter);
    QPixmap pi("C:/Documents/SimpleLoginForm_212218104029/styles/username.png");
    ...
    QPixmap pix("C:/Documents/SimpleLoginForm_212218104029/styles/password.png");
    ...
    connect(btn,&QPushButton::clicked,[=](){
        ...
        QString p=lie->text();
        if(uname=="bharath.k"&& p=="212218104029")
        {
