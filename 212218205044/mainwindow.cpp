    ...
    : QMainWindow(parent)
{
    ...
    l->move(100,50);
    QPixmap p("C:/Users/samat/OneDrive/Documents/SimpleLoginForm_212218205044/styles/login.png");
    l->setPixmap(p.scaled(20,20));

    QLabel *lb=new QLabel(this);
    lb->move(180,25);
    lb->setAlignment(Qt::AlignHCenter);
    QPixmap pi("C:/Users/samat/OneDrive/Documents/SimpleLoginForm_212218205044/styles/username.png");
    ...
    QPixmap pix("C:/Users/samat/OneDrive/Documents/SimpleLoginForm_212218205044/styles/password.png");
    ...
    connect(btn,&QPushButton::clicked,[=](){
        ...
        QString p=lie->text();
        if(uname=="SamathmikaK"&& p=="212218205044")
        {
