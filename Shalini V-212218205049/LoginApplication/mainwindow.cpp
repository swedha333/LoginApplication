    ...
    : QMainWindow(parent)
{
    QLabel *l=new QLabel(this);
        ...
        l->move(100,50);
        QPixmap p("C:/Users/muthu/Documents/LoginApplication/login.png");
        l->setPixmap(p.scaled(20,20));

        QLabel *lb=new QLabel(this);
        lb->move(180,25);
        lb->setAlignment(Qt::AlignHCenter);
        QPixmap pi("C:/Users/muthu/Documents/LoginApplication/user.png");
        ...
        QPixmap pix("C:/Users/muthu/Documents/LoginApplication/pass.jpg");
        ...
        connect(btn,&QPushButton::clicked,[=](){
            ...
            QString p=lie->text();
            if(uname=="ShaliniV"&& p=="212218205049")
            {
